...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '老猫', // 您的昵称
  BIO: process.env.NEXT_PUBLIC_BIO || '喜欢分享，热爱学习', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.xunfei.cc', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '讯飞派，大模型知识分享，产品设计，项目管理', // 网站关键词 英文逗号隔开
